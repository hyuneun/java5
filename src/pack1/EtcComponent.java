...
public class EtcComponent extends Frame implements ItemListener, ActionListener {
	...
	public EtcComponent() {
		...
		rad2 = new Checkbox("o", group, false);
		rad3 = new Checkbox("squre", group, false);
		...
		pn1.add(new Label("coice", Label.RIGHT));
		pn1.add(cho);

		// Checkbox
		chk1 = new Checkbox("ko", true);
		chk2 = new Checkbox("ja", false);
		chk3 = new Checkbox("ame", false);
		pn2 = new Panel();
		btnOk = new Button("ok");
		btnOk.addActionListener(this);
		pn2.add(new Label("Ling counri : "));
		pn2.add(chk1);
		pn2.add(chk2);
		pn2.add(chk3);
		pn2.add(btnOk);
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if (e.getItem().equals("red"))
			c = Color.red;
		else if (e.getItem().equals("ye"))
			c = Color.yellow;
		else if (e.getItem().equals("bule"))
			c = Color.blue;
		else if (e.getItem().equals("bla"))
			c = Color.black;
